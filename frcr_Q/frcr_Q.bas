...
IF COMMAND$ = ""  OR COMMAND$(1) = "?" THEN
    PRINT "FrCr_Q: Fractal Crypter by Stefano Trevisani (c) 2007 Ver 0.1"
    PRINT " Usage: FrCr_Q infile outfile keyfile [option]"
    PRINT " [-c] Crypt"
    PRINT " [-d] DeCrypt"
    PRINT BEL$
    END
...
'faccio un casting a long double
...
SUB LeggiChiave
    ...
    global cx1 as qfloat
    global cy1 as qfloat
    global cx2 as qfloat
    global cy2 as qfloat
