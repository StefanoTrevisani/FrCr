...
GUI "Mandelbrot_D", PIXELS, ICON, 100
...
global v as integer
global t as integer
global cx1 as DOUBLE
global cy1 as DOUBLE
global cx2 as DOUBLE
global cy2 as DOUBLE
...
BEGIN EVENTS
SELECT CASE CBMSG
global x1a as DOUBLE
global y1a as DOUBLE
global x2a as DOUBLE
global y2a as DOUBLE
...
'salvo i dati del file
   ...
   fprint fp1,linea$
   linea$ = "X_MINIMO=" + str$(cx1)
   fprint fp1,linea$

   linea$ = ";Y minimo es: -1.5"
   fprint fp1,linea$
   linea$ = "Y_MINIMO=" + str$(cy1)
   fprint fp1,linea$

   linea$ = ";X massimo es: 2.0"
   fprint fp1,linea$
   linea$ = "X_MASSIMO=" + str$(cx2)
   fprint fp1,linea$

   linea$ = ";Y massimo es: 2.0"
   fprint fp1,linea$
   linea$ = "Y_MASSIMO=" + str$(cy2)
   fprint fp1,linea$
...
SUB Info
    ...
    MsgBox  "Numero Iterazioni -> " + str$(t) + CRLF$ + _
             "X minimo -> " + str$ (cx1) + CRLF$ + _
             "Y minimo -> " + str$ (cy1) + CRLF$ + _
             "X massimo -> " + str$ (cx2) + CRLF$ + _
             "Y massimo -> " + str$ (cy2) + CRLF$ + _
